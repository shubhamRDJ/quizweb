const question =[
    {
        question: "Which is Food does Akshu like the most?",
        answer:[
    ...
    {
        question: "Which Movie Akshu like the most?",
        answer:[
    ...
    {
        question: "Which Hero Akshu like?",
        answer:[
    ...
    {
        question: "Which Footwear Akshu like to wear?",
        answer:[
    ...
    {
        question: "Which IceCream Akshu like the most to eat?",
        answer:[
    ...
    {
        question: "Which type of girl Akshu is?",
        answer:[
    ...
    {
        question: "Which Hairstyle Akshu like the most?",
        answer:[
    ...
    {
        question: "Which Color Akshu like the most?",
        answer:[
    ...
    {
        question: "Which Car Akshu like the most?",
        answer:[
    ...
    {
        question: "Which family Member like the most Akshu in her Home?",
        answer:[
    ...
    {
        question: "Which Clothes Akshu like most to wear?",
        answer:[
...
function imggo(){
    if(img){
    appp.classList.add("go");
    bbox.classList.add("goo");}
}
